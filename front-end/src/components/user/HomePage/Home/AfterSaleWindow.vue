...
import { postAfterSaleApplication, uploadImage } from "@/api/user";
...
async function submit() {
    ...
    try {
        ...
        await postAfterSaleApplication(props.order.orderId, afterSaleReport.value, imagesString);
        ...
        console.error('消费者提交售后申请失败', error);
    } finally {
