        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AVATAR = table.Column<string>(type: "NVARCHAR2(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ADMINROLE = table.Column<string>(type: "NVARCHAR2(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COMMISSIONTHISMONTH = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    STOREFEATURES = table.Column<string>(type: "NVARCHAR2(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COUPONTYPE = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    ...
                    USEDQUANTITY = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SHOPPINGCARTSTATE = table.Column<string>(type: "NVARCHAR2(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SHOPPING_CARTS_STORES_STOREID",
                        column: x => x.STOREID,
                        principalTable: "STORES",
                        principalColumn: "STOREID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PENALTYID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    VIOLATIONPENALTYSTATE = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    PENALTYREASON = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false),
                    PENALTYNOTE = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AFTERSALESTATE = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    PROCESSINGRESULT = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
                    PROCESSINGREASON = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
                    PROCESSINGREMARK = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
                    ORDERID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COMMENTSTATE = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    STOREID = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    STATUS = table.Column<string>(type: "NVARCHAR2(20)", maxLength: 20, nullable: false, defaultValue: "To_Be_Taken"),
                    ...
                    CUSTOMERID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    STOREID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    COURIERID = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    ORDERID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COMPLAINTSTATE = table.Column<string>(type: "NVARCHAR2(50)", maxLength: 50, nullable: false, defaultValue: "Pending"),
                    PROCESSINGRESULT = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
                    PROCESSINGREASON = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
                    PROCESSINGREMARK = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SHOPPING_CARTS_STOREID",
                table: "SHOPPING_CARTS",
                column: "STOREID");
